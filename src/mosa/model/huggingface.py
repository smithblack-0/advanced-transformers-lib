...
MosaForCausalLM wraps MosaModel with everything a researcher needs to
...
The token embedding lives here, not on the backbone. MosaModel is a pure
...
class MosaForCausalLM(PreTrainedModel, GenerationMixin):
    ...
    to MosaModel. Adds loss computation for training, weight tying between the
    ...
    def forward(
        ...
        **kwargs,
        ...
        # per-call arguments override it. Both fields in MosaConfig remain live.
